...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE user SET first_name = '$first_name', last_name = '$last_name', email = '$email', date_of_birth = '$date_of_birth', address = '$address', picture = '$pictureArray->fileName' WHERE user_id = {$id}";
    } else {
        $sql = "UPDATE user SET first_name = '$first_name', last_name = '$last_name', email = '$email', date_of_birth = '$date_of_birth', address = '$address', WHERE user_id = {$id}";
    }
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <tr>
                    <th>Date of birth</th>
                    <td><input class="form-control" type="number" name="date_of_birth" placeholder="Date of birth" value="<?php echo $date_of_birth ?>" /></td>
                </tr>
                <tr>
                    <th>Address</th>
