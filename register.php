...
$error = false;
$fname = $lname = $email = $date_of_birth = $address = $pass = $picture = '';
$fnameError = $lnameError = $emailError = $date_of_birthError = $addressError = $passError = $picError = '';
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO user(first_name, last_name, email, date_of_birth, address, password, picture)
                  VALUES('$fname', '$lname','$email', '$date_of_birth', '$address', '$password','$picture->fileName')";
...
<input type="text" name="fname" class="form-control" placeholder="First name" maxlength="50" value="<?php echo $fname ?>" />
            ...
            <input type="date" name="date_of_birth" class="form-control" placeholder="Enter Your date of birth" maxlength="40" value="<?php echo $date_of_birth ?>" />
            <span class="text-danger"> <?php echo $emailError; ?> </span>
